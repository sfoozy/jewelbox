...
export function getCellColor(cellType: ECellType, cellState: ECellState) {
  switch(cellType) {
    ...
    case ECellType.ULTRA_COMMON_2:
      return cellState === ECellState.MATCHED ? "bg-amber-400" : "bg-gradient-to-tr from-yellow-400 to-orange-500";
    ...
    case ECellType.COMMON_3:
      return cellState === ECellState.MATCHED ? "bg-fuchsia-400" : "bg-gradient-to-tr from-pink-400 to-fuchsia-700";
    case ECellType.RARE_1:
      return cellState === ECellState.MATCHED ? "bg-indigo-300" : "bg-gradient-to-tr from-teal-200 to-violet-500";
    case ECellType.RARE_2:
      return cellState === ECellState.MATCHED ? "bg-red-300" : "bg-gradient-to-tr from-pink-200 to-orange-600";
